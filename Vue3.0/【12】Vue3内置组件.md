...
![KeepAlive1](./assets/KeepAlive1.png)
![KeepAlive2](./assets/KeepAlive2.png)
![KeepAlive3](./assets/KeepAlive3.png)
![KeepAlive4](./assets/KeepAlive4.png)
![KeepAlive5](./assets/KeepAlive5.png)
![KeepAlive6](./assets/KeepAlive6.png)
![KeepAlive7](./assets/KeepAlive7.png)
![KeepAlive8](./assets/KeepAlive8.png)
![KeepAlive9](./assets/KeepAlive9.png)
![KeepAlive10](./assets/KeepAlive10.png)
![KeepAlive11](./assets/KeepAlive11.png)
![KeepAlive12](./assets/KeepAlive12.png)
![KeepAlive13](./assets/KeepAlive13.png)
...
- 接下来在`patch`到`Transition`组件内部具体的html元素节点时`mountElement`方法内部会根据`needCallTransitionHooks`判断是否需要调度节点上的`transition.beforeEnter(el)`，此时会进入`beforeEnter`；
